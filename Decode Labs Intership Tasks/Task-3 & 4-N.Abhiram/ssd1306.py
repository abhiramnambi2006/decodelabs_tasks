...
class SSD1306(framebuf.FrameBuffer):
    ...
    def init_display(self):
        for cmd in (
            SET_DISP | 0x00, SET_MEM_ADDR, 0x00, SET_DISP_START_LINE | 0x00, SET_SEG_REMAP | 0x01,
            SET_MUX_RATIO, self.height - 1, SET_COM_OUT_DIR | 0x08, SET_DISP_OFFSET, 0x00,
            ...
            SET_VCOM_DESEL, 0x30, SET_CONTRAST, 0x7F, SET_ENTIRE_ON, SET_NORM_INV,
